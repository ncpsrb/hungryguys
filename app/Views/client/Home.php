...
<form>
    <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="gamename" id="searchGame">
</form>
        ...
        $("#searchGame").keypress(function(e) {
            ...
            if (e.which == 13) {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        url: '<?= base_url('client/searchGameSession') ?>',
                        type: 'post',
                        data: {
                            gamename: gamename
                        },
                            ...
                            if (response.success === true) {
                                if (result.dismiss === Swal.DismissReason.timer) {
                                    Swal.fire({
                                        ...
                                        $("#searchGame").attr("disabled", false);
                                        window.location = "<?= base_url('client/selection') ?>";
                                    })
                                }
                            } else {
