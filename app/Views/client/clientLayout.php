...
<body>
    <div class="container p-4 border border-danger rounded" style="border-width: 5px !important;">
        <header class="text-center mb-2 bg-danger rounded p-2">
            <h1 class="fw-bold text-white">Hungry Guys Store</h1>
            <ul>
                <li><a class="btn btn-dark btn-md" href="<?= base_url() ?>">Home</a></li>
                <li><a class="btn btn-dark btn-md" href="<?= base_url('payment/status') ?>">Status</a></li>
            </ul>
        </header>
