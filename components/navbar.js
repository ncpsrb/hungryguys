...
export default function Navbar() {
  return (
    <header>
    <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom p-3 fw-bolder">
      <Link href="/" className="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span className="fs-4">Hungry Guys</span>
      </Link>

      <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <Link className="me-3 py-2 text-secondary text-decoration-none" href="admin/login">Features</Link>
        <Link className="me-3 py-2 text-dark text-decoration-none" href="#">Enterprise</Link>
        <Link className="me-3 py-2 text-dark text-decoration-none" href="#">Support</Link>
        <Link className="py-2 text-dark text-decoration-none" href="#">Pricing</Link>
      </nav>
    </div>

    <div className="pricing-header p-3 pb-md-5 mx-auto text-center">
    <Image width={200} height={160} src="/vercel.svg" alt="hero"/>
    <hr/>
